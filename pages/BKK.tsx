...
import { Briefcase, MapPin, Clock, Building, Loader2 } from 'lucide-react';
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="mt-6 md:mt-0">
               <button className="bg-muca-blue text-white px-8 py-3 rounded-full font-bold hover:bg-blue-700 transition-colors shadow-lg border-2 border-transparent hover:border-white/20 transform hover:scale-105 duration-300">
